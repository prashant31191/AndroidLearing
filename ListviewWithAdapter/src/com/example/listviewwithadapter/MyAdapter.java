...
public class MyAdapter extends BaseAdapter{
	...
	public int getCount() {
		...
		return BaseAdapterList.data.size();
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.img.setBackgroundResource((Integer)BaseAdapterList.data.get(position).get("img"));
		holder.title.setText((String)BaseAdapterList.data.get(position).get("title"));
		holder.info.setText((String)BaseAdapterList.data.get(position).get("info"));
